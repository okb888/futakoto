...
| 7 | 月次レポートのPDF/画像エクスポート（react-native-view-shot or expo-print） | 1日 |
| 8 | App Store Connect SKU 作成 + Sandbox テスト | 0.5日 |
| 9 | β配布で課金フロー検証 | 配布期間中 |
